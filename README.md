...
The project focuses on understanding the structure of the dataset, preparing the data for analysis, exploring selected health-related variables, and presenting findings through PivotTables, visualizations, and an Excel dashboard.
...
- Descriptive exploration of selected variables.
...
- Adding a more detailed data dictionary.
- Expanding the exploratory analysis.
